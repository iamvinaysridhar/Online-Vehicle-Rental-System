...
<title>Check out our Cars</title>
...
<table class="data-table">
		<h1 class="title">Check out our Cars</h1>
		<br>
		<thead>
			<tr>
				<th>Car Reg No</th>
...
$query=mysqli_query($conn,"select Car_Reg_No,Car_Name,Car_Rent_Per_Day,Car_Mileage,Car_Availability from cars");
		while($row = mysqli_fetch_array($query))
{
echo "<tr>";
echo "<td>" . $row['Car_Reg_No'] . "</td>";
echo "<td>" . $row['Car_Name'] . "</td>";
echo "<td>" . $row['Car_Rent_Per_Day'] . "</td>";
