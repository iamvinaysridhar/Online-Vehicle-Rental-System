...
<title>Check out our Bikes</title>
...
<table class="data-table">
		<h1 class="title">Check out our Bikes</h1>
		<br>
		<thead>
			<tr>
				<th>Bike Reg No</th>
				<th>Bike Name</th>
				<th>Bike Rent Per Day</th>
				<th>Bike Mileage</th>
...
$query=mysqli_query($conn,"select Bike_Reg_No,Bike_Name,Bike_Rent_Per_Day,Bike_Mileage,Bike_Availability from bikes");
		while($row = mysqli_fetch_array($query))
{
echo "<tr>";
echo "<td>" . $row['Bike_Reg_No'] . "</td>";
echo "<td>" . $row['Bike_Name'] . "</td>";
echo "<td>" . $row['Bike_Rent_Per_Day'] . "</td>";
echo "<td>" . $row['Bike_Mileage'] . "</td>";
echo "<td>" . $row['Bike_Availability'] . "</td>";
echo "</tr>";
}
echo "</table>";
?>
