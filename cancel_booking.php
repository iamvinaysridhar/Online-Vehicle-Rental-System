...
<h1>CANCEL YOUR BOOKING </h1><br>
<form method="post" action="insert1.php" name="myForm">
<tr>
...
<tr>
<td rowspan="2"> <b>Dates for the Booking made</b></td>
...
<h1><b style="font-size:40px">&nbsp;<u>NOTE:</b></h1></u>
 <b style="font-size:30px"><pre> (1) Booking ID was generated and provided to you via a message to the number
 you sent us while you made a booking.</b></pre> 
 <b style="font-size:30px"><pre> (2) Please fill up the form with proper details and no ERRORS before Submitting.</pre></b>
 <br />
</div>
</body>
<script>
